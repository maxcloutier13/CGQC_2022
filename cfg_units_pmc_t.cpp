...
class CGQC_units_PMC_rifleman : cgqc_soldat_moderne
{
	...
	items[] = {"cgqc_items_ifak", "ACRE_PRC343", "ItemAndroid", "ACE_Cellphone", "ACE_EarPlugs", "ACE_CableTie", "ACE_CableTie", "ACE_EntrenchingTool", "hlc_muzzle_SF3P_762R", "rhs_acc_2dpZenit_ris", "rhs_acc_1p87"};
...
class CGQC_units_PMC_0_TeamLeaderSquadLeader : CGQC_units_PMC_rifleman
{
	...
	items[] = {"cgqc_items_ifak", "ACRE_PRC343", "ItemAndroid", "ACE_Cellphone", "azm_bft_tx", "azm_bft_rx", "ACE_EarPlugs", "ACE_CableTie", "ACE_CableTie", "ACE_EntrenchingTool", "ACRE_PRC152", "ACRE_PRC152", "ItemcTab", "hlc_muzzle_SF3P_762R", "rhs_acc_2dpZenit_ris", "rhs_acc_1p87"};
    perks = "sl";
};
...
class CGQC_units_PMC_0_HeavyMachinegunner : CGQC_units_PMC_rifleman
{
	...
	items[] = {"cgqc_items_ifak", "ACRE_PRC343", "ItemAndroid", "ACE_Cellphone", "ACE_EarPlugs", "ACE_CableTie", "ACE_CableTie", "ACE_EntrenchingTool", "rhs_acc_1p87", "HLC_Optic228_Docter_CADEX"};
...
class CGQC_units_PMC_0_Engineer : CGQC_units_PMC_rifleman
{
	...
	items[] = {"cgqc_items_ifak", "ACRE_PRC343", "ItemAndroid", "ACE_Cellphone", "ACE_EarPlugs", "ACE_CableTie", "ACE_CableTie", "ACE_EntrenchingTool", "ACE_M26_Clacker", "ToolKit", "ACE_DefusalKit", "hlc_muzzle_SF3P_762R", "rhs_acc_2dpZenit_ris", "rhs_acc_1p87"};
	perks = "eng";
};
...
{
    displayName = "Medic";
	items[] = {"cgqc_items_ifak", "ACRE_PRC343", "ItemAndroid", "ACE_Cellphone", "ACE_EarPlugs", "ACE_CableTie", "ACE_CableTie", "ACE_EntrenchingTool", "cgqc_items_medkit", "FSGm_ItemMedicBag", "hlc_muzzle_SF3P_762R", "rhs_acc_2dpZenit_ris", "rhs_acc_1p87"};
	perks = "med";
};
...
class CGQC_units_PMC_0_DroneOperator : CGQC_units_PMC_rifleman
{
	...
	items[] = {"cgqc_items_ifak", "ACRE_PRC343", "ItemAndroid", "ACE_Cellphone", "ACE_EarPlugs", "ACE_CableTie", "ACE_CableTie", "ACE_EntrenchingTool", "ACE_UAVBattery", "ACE_UAVBattery", "hlc_muzzle_SF3P_762R", "rhs_acc_2dpZenit_ris", "rhs_acc_1p87"};
};
...
class CGQC_units_PMC_0_Marksman1 : CGQC_units_PMC_rifleman
{
	...
	items[] = {"cgqc_items_ifak", "ACRE_PRC343", "ItemAndroid", "ACE_Cellphone", "ACE_EarPlugs", "ACE_CableTie", "ACE_CableTie", "ACE_EntrenchingTool", "ACE_Kestrel4500", "ACE_ATragMX", "ACE_Flashlight_KSF1", "hlc_optic_ATACR_Offset"};
...
class CGQC_units_PMC_0_Marksman2 : CGQC_units_PMC_rifleman
{
	...
	items[] = {"cgqc_items_ifak", "ACRE_PRC343", "ItemAndroid", "ACE_Cellphone", "ACE_EarPlugs", "ACE_CableTie", "ACE_CableTie", "ACE_EntrenchingTool", "ACE_Kestrel4500", "ACE_ATragMX", "ACE_Flashlight_KSF1", "rhsusf_acc_premier_mrds"};
};
