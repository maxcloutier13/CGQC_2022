...
if (!isNil "_crate") then {
    ...
    _adding = [ _crate, 0, ["ACE_MainActions" , "menu_supplies"], _action ] call  ace_interact_menu_fnc_addActionToObject;
    //  60mm mortar crate 
    _action = [ "menu_supplies_60", "60mm mortar box", "", {["mort60"] execVM "\CGQC_2022\loadouts\mk1_box_get_items.sqf"}, {cgqc_player_rank > 3 || !cgqc_mk2_arsenal_locked} ] call ace_interact_menu_fnc_createAction;
    _adding = [ _crate, 0, ["ACE_MainActions" , "menu_supplies"], _action ] call  ace_interact_menu_fnc_addActionToObject;
    //  82mm mortar crate
    _action = [ "menu_supplies_82", "82mm mk6 mortar box", "", {["mort82"] execVM "\CGQC_2022\loadouts\mk1_box_get_items.sqf"}, {cgqc_player_rank > 3 || !cgqc_mk2_arsenal_locked} ] call ace_interact_menu_fnc_createAction;
    _adding = [ _crate, 0, ["ACE_MainActions" , "menu_supplies"], _action ] call  ace_interact_menu_fnc_addActionToObject;
    //  Spare wheel
