...
private _act = "{['on'] execVM '\cgqc_2022\scripts\cgqc_refuel_actions.sqf'}  forEach (allUnits inAreaArray thisTrigger);";
private _deAct = "['off'] execVM '\cgqc_2022\scripts\cgqc_refuel_actions.sqf';";
private _int = 2;
